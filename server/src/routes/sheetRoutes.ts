...
sheetRoutes.delete('/sheet', isAuthenticated, sheetController.deleteSheet);
...
sheetRoutes.patch('/sheet/:sheetId/row-hid', isAuthenticated, sheetController.updateHiddenRows);
sheetRoutes.patch('/sheet/:sheetId/col-hid', isAuthenticated, sheetController.updateHiddenCols);
